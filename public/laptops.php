...
$products = $conn->query("SELECT * FROM products WHERE type='Laptop' ORDER BY id DESC");
...
<title>Laptops - Computer Shop</title>
<style>
...
footer h3, footer p { margin:5px 0; }

@media(max-width:768px){.hamburger{display:block;}}
@media(max-width:500px){.navbar{flex-direction:column;align-items:flex-start;}}
