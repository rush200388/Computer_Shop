...
// Fetch Graphics Cards only
$products = $conn->query("SELECT * FROM products WHERE type='Graphics Card' ORDER BY id DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<title>Graphics Cards - Computer Shop</title>
<style>
...
<div id="sidePanel">
  ...
  <a href="graphics.php">Graphics Cards</a>
